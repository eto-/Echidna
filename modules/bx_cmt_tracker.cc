 ...
 *
 * $Id: bx_cmt_tracker.cc,v 1.3 2013/01/29 06:15:37 mosteiro Exp $
 *
...
// ctor
bx_cmt_tracker::bx_cmt_tracker (): bx_base_module("bx_cmt_tracker", bx_base_module::main_loop) {
...
bx_echidna_event* bx_cmt_tracker::doit (bx_echidna_event *ev) {
...
// Private method(s)
bool bx_cmt_tracker::m_check_this_and_that(const bx_laben_event& er) {
  // ...
  return true;
}

/*
 * $Log: bx_cmt_tracker.cc,v $
 * Revision 1.3  2013/01/29 06:15:37  mosteiro
