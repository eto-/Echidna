...
void bx_precalib_muon_gate::begin () {
  ...
  min_gate_width = (uint16_t)(get_parameter(is_new_tdc ? "min_new_gate_width" : "min_gate_width").get_int());
  max_gate_width = (uint16_t)(get_parameter(is_new_tdc ? "max_new_gate_width" : "max_gate_width").get_int());
