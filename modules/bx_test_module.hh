 ...
 *
 * $Id: bx_test_module.hh,v 1.6 2005/02/03 19:00:18 ddangelo Exp $
 *
...
#ifndef _BX_TEST_MODULE_HH
#define _BX_TEST_MODULE_HH
...
class bx_test_module: public bx_base_module {
  public:
  // this section if fixed; do not edit
    bx_test_module ();
    virtual ~bx_test_module () {}
