#ifndef _BX_DB_MON_MMS_MON_DIALOG_H
#define _BX_DB_MON_MMS_MON_DIALOG_H
...
class MMSDialog : public QDialog
{
  Q_OBJECT

  public:
    MMSDialog(QWidget *parent = 0);
    ~MMSDialog();
  ...
  private:
    ...
    static const int N_fields = 2;  // remember add  +1 for unselected option
    static const int N_types1 = 17; // remember add  +1 for unselected option
